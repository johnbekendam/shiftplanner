...
- [x] Clear the flag after a successful run of the cycle. Test success, failure, and a run for a cycle that holds no open pair.
- [x] Add the Allow autoplanner toggle to the workcenter card. Test that it shows only when published, and that it calls the endpoint.
