...
- [ ] Make the generator skip the open spots of frozen published pairs, and fill the spots of open pairs. Test frozen, open, unfulfilled reporting, and that existing assignments never move.
