...
const NORMAL =
    ...
    'hover:border-[var(--color-btn-primary-hover-border)] hover:bg-[var(--color-btn-primary-hover-bg)] hover:text-[var(--color-btn-primary-hover-text)]'
const HOVER =
    'border-[var(--color-btn-primary-hover-border)] bg-[var(--color-btn-primary-hover-bg)] text-[var(--color-btn-primary-hover-text)]'
const DISABLED =
    'pointer-events-none cursor-not-allowed border-[var(--color-btn-primary-disabled-border)] bg-[var(--color-btn-primary-disabled-bg)] text-[var(--color-btn-primary-disabled-text)]'
